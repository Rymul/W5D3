...
VALUES
    ((SELECT id FROM questions WHERE title = 'What is a query?'), (SELECT id FROM users WHERE fname = 'Taowei'))
    ((SELECT id FROM questions WHERE title = 'What time is it?'), (SELECT id FROM users WHERE fname = 'Ryan'))
    ((SELECT id FROM questions WHERE title = 'When is the next assessment?'), (SELECT id FROM users WHERE fname = 'Darren'))
    ((SELECT id FROM questions WHERE title = 'When does class start?'), (SELECT id FROM users WHERE fname = 'Disnee'))
    ((SELECT id FROM questions WHERE title = 'When is the next assessment?'), (SELECT id FROM users WHERE fname = 'Taowei'))
    ((SELECT id FROM questions WHERE title = 'When is the next assessment?'), (SELECT id FROM users WHERE fname = 'Ryan'));
...
VALUES
    ((SELECT id FROM questions WHERE title = 'What is a query?'), (SELECT id FROM users WHERE fname = 'Disnee'))
    ((SELECT id FROM questions WHERE title = 'What time is it?'), (SELECT id FROM users WHERE fname = 'Darren'))
    ((SELECT id FROM questions WHERE title = 'When is the next assessment?'), (SELECT id FROM users WHERE fname = 'Ryan'))
    ((SELECT id FROM questions WHERE title = 'When does class start?'), (SELECT id FROM users WHERE fname = 'Taowei'))
    ((SELECT id FROM questions WHERE title = 'When is the next assessment?'), (SELECT id FROM users WHERE fname = 'Darren'))
    ((SELECT id FROM questions WHERE title = 'When is the next assessment?'), (SELECT id FROM users WHERE fname = 'Disnee'));
